...
<nav style = "background-color:rgba(0, 0, 0, 0.1);" class = "navbar navbar-default">
	...
	<ul id = "menu">
		...
		<li><a href = "aircraftreservation.php">Aircraft</a></li> |
		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<?php 
					...
					$query = $conn->query("SELECT * FROM `flight` WHERE `flight_id` = '$_REQUEST[flight_id]'") or die(mysql_error());
				...
				<div style = "height:300px; width:800px;">
					...
					<div style = "float:left; margin-left:10px;">
						...
						<h3 style = "color:rgb(255,0,0);"><?php echo "Rp ".$fetch['price'].".00";?></h3>
					</div>
				</div>
				<br style = "clear:both;" />
